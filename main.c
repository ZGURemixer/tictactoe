...
int main() {
    ...
    do {
        ...
        switch (option) {
            ...
            case 2:  // About
                printf(
                    "This is a small project I made in C during the summer of "
                    "2024 to practice my coding skills.\n");
                printf(
                    "To play the game, each PLAYER takes turns to fill a %dx%d "
                    "grid with their symbol.\n",
                    SIZE, SIZE);
